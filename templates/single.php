    ...
    class MYPDF extends TCPDF {
        ...
        public function AddMySection($ciniki, $tnid, $category_title, $title, $section, $newpage='no') {
            ...
            if( $section['content'] != '' ) {
                ...
                // Convert <a href=" to <a href=' (single quote matters to tcpdf)
//                $section['content'] = preg_replace("/href=\"([^\"]+)\"/mi", "href='$1'", $section['content']);
                $this->SetFont('', '', '12');
            ...
            if( $section['content'] != '' ) {
                ...
                $this->MultiCell($page_width, 8, trim($section['content']), 0, 'L', false, 1, '', '', true, 0, true, true, 0, 'T');
            }
            if( isset($num_pages) ) {
